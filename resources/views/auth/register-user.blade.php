<x-layouts.auth :title="__('admin.auth.simple_user_register_title')">
    <form method="POST" action="{{ route('register.user.store') }}" class="panel-auth-form panel-auth-form-grid">
        @csrf
