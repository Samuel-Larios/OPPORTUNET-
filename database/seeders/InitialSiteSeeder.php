...
class InitialSiteSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['cle' => 'whatsapp_numero', 'fr' => '+2290167229575', 'en' => '+2290167229575', 'type' => 'texte', 'groupe' => 'whatsapp', 'label' => 'Numero WhatsApp', 'public' => true],
            ...
            ['cle' => 'whatsapp_groupe_priere_url', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'whatsapp', 'label' => 'Lien du groupe WhatsApp de priere', 'public' => false],
            ['cle' => 'support_kkiapay_url', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'Lien KKIA Pay', 'public' => false],
            ['cle' => 'support_bank_name', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'Nom de la banque', 'public' => false],
            ['cle' => 'support_bank_account_name', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'Titulaire du compte bancaire', 'public' => false],
            ['cle' => 'support_bank_account_number', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'Numero de compte bancaire', 'public' => false],
            ['cle' => 'support_bank_iban', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'IBAN', 'public' => false],
            ['cle' => 'support_bank_swift', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'paiement', 'label' => 'Code SWIFT / BIC', 'public' => false],
            ['cle' => 'security_captcha_enabled', 'fr' => '1', 'en' => '1', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Activer le CAPTCHA sur les formulaires publics', 'public' => false],
            ['cle' => 'security_ip_auto_block_threshold', 'fr' => '5', 'en' => '5', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Seuil de blocage automatique IP', 'public' => false],
            ['cle' => 'security_ip_auto_block_window_minutes', 'fr' => '60', 'en' => '60', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Fenetre d analyse des incidents (minutes)', 'public' => false],
            ['cle' => 'security_ip_block_duration_minutes', 'fr' => '1440', 'en' => '1440', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Duree du blocage automatique IP (minutes)', 'public' => false],
            ['cle' => 'security_geo_mode', 'fr' => 'off', 'en' => 'off', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Mode de filtrage geographique', 'public' => false],
            ['cle' => 'security_geo_countries', 'fr' => '', 'en' => '', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'Liste des pays geographiques (codes ISO)', 'public' => false],
            ['cle' => 'security_geo_header', 'fr' => 'CF-IPCountry', 'en' => 'CF-IPCountry', 'type' => 'texte', 'groupe' => 'securite', 'label' => 'En-tete de pays utilise par le proxy/CDN', 'public' => false],
