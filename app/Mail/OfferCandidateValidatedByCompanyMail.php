...
class OfferCandidateValidatedByCompanyMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: __('offers.application.company_validation_mail.subject', [
    ...
    {
        return new Content(
            view: 'emails.offer-candidate-validated-by-company',
        );
    }
}
